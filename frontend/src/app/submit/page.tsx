...
export default function SubmitRecipePage() {
  ...
  const handleReset = () => {
    ...
    setTitle("");
    setDescription("");
    setIngredients([{ amount: "", name: "" }, { amount: "", name: "" }]);
    setSteps("");
    setError(null);
  };
          ...
          <div className="bg-white dark:bg-[#1a0c0f] rounded-lg shadow-sm p-6 sm:p-8 flex flex-col gap-8 border border-[#f0ebec] dark:border-[#3a2025]">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[#181112] dark:text-gray-100 text-base font-bold leading-normal" htmlFor="recipe-name">
                  What do you call this masterpiece? <span className="text-primary">*</span>
                </label>
                <input
                  id="recipe-name"
                  type="text"
              ...
              {/* Description */}
              <div className="flex flex-col gap-2">
                <label className="text-[#181112] dark:text-gray-100 text-base font-bold leading-normal" htmlFor="recipe-desc">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-3">
                  {ingredients.map((ing, idx) => (
                    <div key={idx} className="flex flex-wrap sm:flex-nowrap gap-3 items-start">
              ...
              {/* Instructions */}
              <div className="flex flex-col gap-2">
                <label className="text-[#181112] dark:text-gray-100 text-base font-bold leading-normal" htmlFor="instructions">
                  How do we make it?
                </label>
                <textarea
                  id="instructions"
